...
export const getBrokerTickets = (query = '') =>
  fetchJson(`${API_BASE}/broker/tickets${query}`, {
    headers: { ...headers(), 'Content-Type': 'application/json' }
  });

export const createBrokerTicket = (payload) =>
  fetchJson(`${API_BASE}/broker/tickets`, {
    method: 'POST',
    headers: { ...headers(), 'Content-Type': 'application/json' },
...
export const getBrokerTicketThread = (id) =>
  fetchJson(`${API_BASE}/broker/tickets/${id}`, {
    headers: { ...headers(), 'Content-Type': 'application/json' }
  });

export const replyBrokerTicket = (id, payload) =>
  fetchJson(`${API_BASE}/broker/tickets/${id}/replies`, {
    method: 'POST',
    headers: { ...headers(), 'Content-Type': 'application/json' },
    body: JSON.stringify(payload)
  });